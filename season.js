...
/* THE LOT's role marks — same vocabulary and assets as the guide's
   ROLE_META; an event wears the marks of who it's FOR. roles[0] is
   the primary mark (worn on the timeline node). */
window.SEASON_ROLES = {
  scriptographer:  { img: 'role-scriptographer.svg',  label: 'Scriptographers'  },
  director:        { img: 'role-director.svg',        label: 'Directors'        },
  cineaste:        { img: 'role-cineaste.svg',        label: 'Cineastes'        },
  cinematographer: { img: 'role-cinematographer.svg', label: 'Cinematographers' },
  scenographer:    { img: 'role-scenographer.svg',    label: 'Scenographers'    },
};
...
window.SEASON = {
  ...
  events: [
    ...
    { n: 6,  slug: 'last-call',        short: 'LAST CALL',         name: 'Last Call',
      ...
      roles: ['cinematographer', 'scenographer'],
      tag: 'Crew up',
    ...
    { n: 12, slug: 'premiere',         short: 'PREMIERE!',         name: 'Premiere!',
      ...
      roles: ['cineaste', 'scriptographer', 'director', 'cinematographer', 'scenographer'],
      tag: 'The closing episode — everyone\'s night',
